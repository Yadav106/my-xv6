...
int main() {
  ...
  printf(1, "Hello, World!\n");
   1:	b8 d8 07 00 00       	mov    $0x7d8,%eax
int main() {
   6:	89 e5                	mov    %esp,%ebp
  ...
  19:	e8 12 04 00 00       	call   430 <printf>
  exit();
 ...
 37b:	89 d1                	mov    %edx,%ecx
{
 ...
 3bc:	0f b6 92 48 08 00 00 	movzbl 0x848(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a3:	ff 24 85 f0 07 00 00 	jmp    *0x7f0(,%eax,4)
 ...
 624:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
          s = "(null)";
 628:	bf e7 07 00 00       	mov    $0x7e7,%edi
...
free(void *ap)
{
 ...
 641:	a1 5c 08 00 00       	mov    0x85c,%eax
{
 ...
 689:	5b                   	pop    %ebx
  freep = p;
 68a:	89 15 5c 08 00 00    	mov    %edx,0x85c
}
 690:	5e                   	pop    %esi
 691:	5f                   	pop    %edi
 692:	5d                   	pop    %ebp
 ...
 6c7:	75 be                	jne    687 <free+0x47>
  freep = p;
 6c9:	89 15 5c 08 00 00    	mov    %edx,0x85c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 5c 08 00 00    	mov    0x85c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 737:	73 3f                	jae    778 <malloc+0x88>
    ...
    if(p == freep)
 739:	39 05 5c 08 00 00    	cmp    %eax,0x85c
 ...
 759:	e8 e2 fe ff ff       	call   640 <free>
  return freep;
 75e:	8b 15 5c 08 00 00    	mov    0x85c,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 5c 08 00 00    	mov    %edx,0x85c
}
 ...
 79f:	00 
    base.s.ptr = freep = prevp = &base;
 7a0:	b8 60 08 00 00       	mov    $0x860,%eax
 7a5:	ba 60 08 00 00       	mov    $0x860,%edx
 7aa:	a3 5c 08 00 00       	mov    %eax,0x85c
    base.s.size = 0;
 7af:	31 c9                	xor    %ecx,%ecx
 7b1:	b8 60 08 00 00       	mov    $0x860,%eax
    base.s.ptr = freep = prevp = &base;
 7b6:	89 15 60 08 00 00    	mov    %edx,0x860
    base.s.size = 0;
 7bc:	89 0d 64 08 00 00    	mov    %ecx,0x864
    if(p->s.size >= nunits){
