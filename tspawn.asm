...
_tspawn:     file format elf32-i386
  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  17:	8b 41 04             	mov    0x4(%ecx),%eax
    if (argc < 2)
  1a:	0f 8e da 00 00 00    	jle    fa <main+0xfa>
  ...
  2b:	31 c9                	xor    %ecx,%ecx
    int pids[n];
  2d:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
    int n = atoi(argv[1]);
  34:	89 c3                	mov    %eax,%ebx
    int pids[n];
  36:	8d 42 0f             	lea    0xf(%edx),%eax
  39:	83 e0 f0             	and    $0xfffffff0,%eax
  3c:	29 c4                	sub    %eax,%esp
    memset(pids, 0, sizeof(pids));
  3e:	89 54 24 08          	mov    %edx,0x8(%esp)
    int pids[n];
  42:	8d 7c 24 0c          	lea    0xc(%esp),%edi
    memset(pids, 0, sizeof(pids));
  ...
  52:	89 7c 24 04          	mov    %edi,0x4(%esp)
  56:	89 1c 24             	mov    %ebx,(%esp)
  59:	e8 f5 03 00 00       	call   453 <spawn>
  ...
  60:	89 c6                	mov    %eax,%esi
    if (num_child < 0)
  62:	0f 88 b1 00 00 00    	js     119 <main+0x119>
  ...
  6d:	0f 84 bf 00 00 00    	je     132 <main+0x132>
  73:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  7a:	00 
  7b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        {
            int cpid = wait();
  80:	e8 16 03 00 00       	call   39b <wait>
            printf(1, "Parent reaped children with id %d successfully\n", cpid);
  85:	ba 1c 09 00 00       	mov    $0x91c,%edx
        for (int i = 0; i < num_child; i++)
  8a:	43                   	inc    %ebx
            printf(1, "Parent reaped children with id %d successfully\n", cpid);
  8b:	89 54 24 04          	mov    %edx,0x4(%esp)
  8f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  96:	89 44 24 08          	mov    %eax,0x8(%esp)
  9a:	e8 b1 04 00 00       	call   550 <printf>
        for (int i = 0; i < num_child; i++)
  9f:	39 de                	cmp    %ebx,%esi
  a1:	7f dd                	jg     80 <main+0x80>
        }

        printf(1,"Child PID list:\n");
  a3:	c7 44 24 04 72 09 00 	movl   $0x972,0x4(%esp)
  aa:	00 
  ...
  b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        {
            printf(1, "%d ", pids[i]);
  c0:	8b 04 9f             	mov    (%edi,%ebx,4),%eax
        for (int i = 0; i < num_child; i++)
  c3:	43                   	inc    %ebx
            printf(1, "%d ", pids[i]);
  c4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  cb:	89 44 24 08          	mov    %eax,0x8(%esp)
  cf:	b8 83 09 00 00       	mov    $0x983,%eax
  d4:	89 44 24 04          	mov    %eax,0x4(%esp)
  d8:	e8 73 04 00 00       	call   550 <printf>
        for (int i = 0; i < num_child; i++)
  dd:	39 de                	cmp    %ebx,%esi
  df:	7f df                	jg     c0 <main+0xc0>

        }

        printf(1, "\n");
  e1:	c7 44 24 04 70 09 00 	movl   $0x970,0x4(%esp)
  e8:	00 
  e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f0:	e8 5b 04 00 00       	call   550 <printf>
    }

    exit();
  f5:	e8 99 02 00 00       	call   393 <exit>
        printf(1, "Usage: %s <program> [arguments...]\n", argv[0]);
  fa:	8b 00                	mov    (%eax),%eax
  fc:	c7 44 24 04 f8 08 00 	movl   $0x8f8,0x4(%esp)
 103:	00 
 104:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 10b:	89 44 24 08          	mov    %eax,0x8(%esp)
 10f:	e8 3c 04 00 00       	call   550 <printf>
        exit();
 114:	e8 7a 02 00 00       	call   393 <exit>
        printf(1, "Spawn failed\n");
 119:	c7 44 24 04 4c 09 00 	movl   $0x94c,0x4(%esp)
 120:	00 
 121:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 128:	e8 23 04 00 00       	call   550 <printf>
        exit();
 12d:	e8 61 02 00 00       	call   393 <exit>
        printf(1,"Hi from spawned child \n");
 132:	c7 44 24 04 5a 09 00 	movl   $0x95a,0x4(%esp)
 139:	00 
 13a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 141:	e8 0a 04 00 00       	call   550 <printf>
        exit();
 146:	e8 48 02 00 00       	call   393 <exit>
 ...
 49b:	89 d1                	mov    %edx,%ecx
{
 ...
 4dc:	0f b6 92 e8 09 00 00 	movzbl 0x9e8(%edx),%edx
 ...
 559:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c3:	ff 24 85 90 09 00 00 	jmp    *0x990(,%eax,4)
 ...
 744:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
          s = "(null)";
 748:	bf 87 09 00 00       	mov    $0x987,%edi
...
free(void *ap)
{
 ...
 761:	a1 fc 09 00 00       	mov    0x9fc,%eax
{
 ...
 7a9:	5b                   	pop    %ebx
  freep = p;
 7aa:	89 15 fc 09 00 00    	mov    %edx,0x9fc
}
 7b0:	5e                   	pop    %esi
 7b1:	5f                   	pop    %edi
 7b2:	5d                   	pop    %ebp
 ...
 7e7:	75 be                	jne    7a7 <free+0x47>
  freep = p;
 7e9:	89 15 fc 09 00 00    	mov    %edx,0x9fc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 819:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 81c:	8b 15 fc 09 00 00    	mov    0x9fc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 857:	73 3f                	jae    898 <malloc+0x88>
    ...
    if(p == freep)
 859:	39 05 fc 09 00 00    	cmp    %eax,0x9fc
 ...
 879:	e8 e2 fe ff ff       	call   760 <free>
  return freep;
 87e:	8b 15 fc 09 00 00    	mov    0x9fc,%edx
 ...
 8a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 8a7:	89 15 fc 09 00 00    	mov    %edx,0x9fc
}
 ...
 8bf:	00 
    base.s.ptr = freep = prevp = &base;
 8c0:	b8 00 0a 00 00       	mov    $0xa00,%eax
 8c5:	ba 00 0a 00 00       	mov    $0xa00,%edx
 8ca:	a3 fc 09 00 00       	mov    %eax,0x9fc
    base.s.size = 0;
 8cf:	31 c9                	xor    %ecx,%ecx
 8d1:	b8 00 0a 00 00       	mov    $0xa00,%eax
    base.s.ptr = freep = prevp = &base;
 8d6:	89 15 00 0a 00 00    	mov    %edx,0xa00
    base.s.size = 0;
 8dc:	89 0d 04 0a 00 00    	mov    %ecx,0xa04
    if(p->s.size >= nunits){
