...
main(int argc, char *argv[])
{
  ...
  45:	e8 41 03 00 00       	call   38b <close>
  for(i = 1; i < argc; i++){
  4a:	39 75 08             	cmp    %esi,0x8(%ebp)
  4d:	75 d1                	jne    20 <main+0x20>
  }
  exit();
  4f:	e8 0f 03 00 00       	call   363 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  54:	8b 07                	mov    (%edi),%eax
  56:	c7 44 24 04 eb 08 00 	movl   $0x8eb,0x4(%esp)
  5d:	00 
...
00000090 <cat>:
{
  ...
  a4:	b8 80 09 00 00       	mov    $0x980,%eax
  ...
  c5:	ba 80 09 00 00       	mov    $0x980,%edx
 ...
 46b:	89 d1                	mov    %edx,%ecx
{
 ...
 4ac:	0f b6 92 60 09 00 00 	movzbl 0x960(%edx),%edx
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 593:	ff 24 85 08 09 00 00 	jmp    *0x908(,%eax,4)
 ...
 714:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
          s = "(null)";
 718:	bf 00 09 00 00       	mov    $0x900,%edi
...
free(void *ap)
{
 ...
 731:	a1 80 0b 00 00       	mov    0xb80,%eax
{
 ...
 779:	5b                   	pop    %ebx
  freep = p;
 77a:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 780:	5e                   	pop    %esi
 781:	5f                   	pop    %edi
 782:	5d                   	pop    %ebp
 ...
 7b7:	75 be                	jne    777 <free+0x47>
  freep = p;
 7b9:	89 15 80 0b 00 00    	mov    %edx,0xb80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ec:	8b 15 80 0b 00 00    	mov    0xb80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 827:	73 3f                	jae    868 <malloc+0x88>
    ...
    if(p == freep)
 829:	39 05 80 0b 00 00    	cmp    %eax,0xb80
 ...
 849:	e8 e2 fe ff ff       	call   730 <free>
  return freep;
 84e:	8b 15 80 0b 00 00    	mov    0xb80,%edx
 ...
 874:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 877:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 ...
 88f:	00 
    base.s.ptr = freep = prevp = &base;
 890:	b8 84 0b 00 00       	mov    $0xb84,%eax
 895:	ba 84 0b 00 00       	mov    $0xb84,%edx
 89a:	a3 80 0b 00 00       	mov    %eax,0xb80
    base.s.size = 0;
 89f:	31 c9                	xor    %ecx,%ecx
 8a1:	b8 84 0b 00 00       	mov    $0xb84,%eax
    base.s.ptr = freep = prevp = &base;
 8a6:	89 15 84 0b 00 00    	mov    %edx,0xb84
    base.s.size = 0;
 8ac:	89 0d 88 0b 00 00    	mov    %ecx,0xb88
    if(p->s.size >= nunits){
