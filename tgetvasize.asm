...
_tgetvasize:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  55:	e8 91 03 00 00       	call   3eb <sbrk>
  5a:	b9 10 09 00 00       	mov    $0x910,%ecx
  ...
  73:	c7 04 24 00 04 00 00 	movl   $0x400,(%esp)
  7a:	e8 6c 03 00 00       	call   3eb <sbrk>
  7f:	89 c3                	mov    %eax,%ebx
  int process_size_after_sbrk = getvasize(getpid());
  81:	e8 5d 03 00 00       	call   3e3 <getpid>
  86:	89 04 24             	mov    %eax,(%esp)
  89:	e8 9d 03 00 00       	call   42b <getvasize>
  printf(1, "Size of process:          %d Bytes\n", process_size_after_sbrk);
  8e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  95:	89 44 24 08          	mov    %eax,0x8(%esp)
  99:	b8 ec 08 00 00       	mov    $0x8ec,%eax
  9e:	89 44 24 04          	mov    %eax,0x4(%esp)
  a2:	e8 79 04 00 00       	call   520 <printf>
  printf(1, "Address returned by sbrk: 0x%x\n", sbrk_after);
  a7:	b8 10 09 00 00       	mov    $0x910,%eax
  ac:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  b0:	89 44 24 04          	mov    %eax,0x4(%esp)
  b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  bb:	e8 60 04 00 00       	call   520 <printf>


  char *sbrk_after_4096 = sbrk(4096); // sbrk increase process by n bytes
  c0:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  c7:	e8 1f 03 00 00       	call   3eb <sbrk>
  cc:	89 c3                	mov    %eax,%ebx
  int process_size_after_sbrk_after_4096 = getvasize(getpid());
  ce:	e8 10 03 00 00       	call   3e3 <getpid>
  d3:	89 04 24             	mov    %eax,(%esp)
  d6:	e8 50 03 00 00       	call   42b <getvasize>
  printf(1, "Size of process:          %d Bytes\n", process_size_after_sbrk_after_4096);
  db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  e2:	89 44 24 08          	mov    %eax,0x8(%esp)
  e6:	b8 ec 08 00 00       	mov    $0x8ec,%eax
  eb:	89 44 24 04          	mov    %eax,0x4(%esp)
  ef:	e8 2c 04 00 00       	call   520 <printf>
  printf(1, "Address returned by sbrk: 0x%x\n", sbrk_after_4096);
  f4:	b8 10 09 00 00       	mov    $0x910,%eax
  f9:	89 44 24 04          	mov    %eax,0x4(%esp)
  fd:	89 5c 24 08          	mov    %ebx,0x8(%esp)
 101:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 108:	e8 13 04 00 00       	call   520 <printf>

  exit();
 10d:	e8 51 02 00 00       	call   363 <exit>
 ...
 46b:	89 d1                	mov    %edx,%ecx
{
 ...
 4ac:	0f b6 92 88 09 00 00 	movzbl 0x988(%edx),%edx
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 593:	ff 24 85 30 09 00 00 	jmp    *0x930(,%eax,4)
 ...
 714:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
          s = "(null)";
 718:	bf e2 08 00 00       	mov    $0x8e2,%edi
...
free(void *ap)
{
 ...
 731:	a1 9c 09 00 00       	mov    0x99c,%eax
{
 ...
 779:	5b                   	pop    %ebx
  freep = p;
 77a:	89 15 9c 09 00 00    	mov    %edx,0x99c
}
 780:	5e                   	pop    %esi
 781:	5f                   	pop    %edi
 782:	5d                   	pop    %ebp
 ...
 7b7:	75 be                	jne    777 <free+0x47>
  freep = p;
 7b9:	89 15 9c 09 00 00    	mov    %edx,0x99c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ec:	8b 15 9c 09 00 00    	mov    0x99c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 827:	73 3f                	jae    868 <malloc+0x88>
    ...
    if(p == freep)
 829:	39 05 9c 09 00 00    	cmp    %eax,0x99c
 ...
 849:	e8 e2 fe ff ff       	call   730 <free>
  return freep;
 84e:	8b 15 9c 09 00 00    	mov    0x99c,%edx
 ...
 874:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 877:	89 15 9c 09 00 00    	mov    %edx,0x99c
}
 ...
 88f:	00 
    base.s.ptr = freep = prevp = &base;
 890:	b8 a0 09 00 00       	mov    $0x9a0,%eax
 895:	ba a0 09 00 00       	mov    $0x9a0,%edx
 89a:	a3 9c 09 00 00       	mov    %eax,0x99c
    base.s.size = 0;
 89f:	31 c9                	xor    %ecx,%ecx
 8a1:	b8 a0 09 00 00       	mov    $0x9a0,%eax
    base.s.ptr = freep = prevp = &base;
 8a6:	89 15 a0 09 00 00    	mov    %edx,0x9a0
    base.s.size = 0;
 8ac:	89 0d a4 09 00 00    	mov    %ecx,0x9a4
    if(p->s.size >= nunits){
