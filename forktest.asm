...
00000040 <forktest>:
{
  ...
  write(fd, s, strlen(s));
  4b:	c7 04 24 8c 04 00 00 	movl   $0x48c,(%esp)
  52:	e8 79 01 00 00       	call   1d0 <strlen>
  57:	b9 8c 04 00 00       	mov    $0x48c,%ecx
  ...
  for(n=0; n<N; n++){
  70:	eb 19                	jmp    8b <forktest+0x4b>
  72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(pid == 0)
  78:	0f 84 8b 00 00 00    	je     109 <forktest+0xc9>
  for(n=0; n<N; n++){
  7e:	43                   	inc    %ebx
  7f:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
  85:	0f 84 9c 00 00 00    	je     127 <forktest+0xe7>
    pid = fork();
  8b:	e8 fb 02 00 00       	call   38b <fork>
    if(pid < 0)
  90:	85 c0                	test   %eax,%eax
  92:	79 e4                	jns    78 <forktest+0x38>
  for(; n > 0; n--){
  94:	85 db                	test   %ebx,%ebx
  96:	74 14                	je     ac <forktest+0x6c>
  98:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  9f:	00 
    if(wait() < 0){
  a0:	e8 f6 02 00 00       	call   39b <wait>
  a5:	85 c0                	test   %eax,%eax
  a7:	78 3b                	js     e4 <forktest+0xa4>
  for(; n > 0; n--){
  a9:	4b                   	dec    %ebx
  ...
  b5:	40                   	inc    %eax
  b6:	75 56                	jne    10e <forktest+0xce>
  write(fd, s, strlen(s));
  b8:	c7 04 24 be 04 00 00 	movl   $0x4be,(%esp)
  bf:	e8 0c 01 00 00       	call   1d0 <strlen>
  c4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  cb:	89 44 24 08          	mov    %eax,0x8(%esp)
  cf:	b8 be 04 00 00       	mov    $0x4be,%eax
  ...
  e3:	c3                   	ret
  write(fd, s, strlen(s));
  e4:	c7 04 24 97 04 00 00 	movl   $0x497,(%esp)
  eb:	e8 e0 00 00 00       	call   1d0 <strlen>
  f0:	ba 97 04 00 00       	mov    $0x497,%edx
  f5:	89 54 24 04          	mov    %edx,0x4(%esp)
  f9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 100:	89 44 24 08          	mov    %eax,0x8(%esp)
 104:	e8 aa 02 00 00       	call   3b3 <write>
      exit();
 109:	e8 85 02 00 00       	call   393 <exit>
    printf(1, "wait got too many\n");
 10e:	c7 44 24 04 ab 04 00 	movl   $0x4ab,0x4(%esp)
 115:	00 
 116:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 11d:	e8 ee fe ff ff       	call   10 <printf>
    exit();
 122:	e8 6c 02 00 00       	call   393 <exit>
    printf(1, "fork claimed to work N times!\n", N);
 127:	c7 44 24 08 e8 03 00 	movl   $0x3e8,0x8(%esp)
 12e:	00 
 12f:	c7 44 24 04 cc 04 00 	movl   $0x4cc,0x4(%esp)
 136:	00 
