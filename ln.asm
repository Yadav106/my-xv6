   ...
   a:	83 7d 08 03          	cmpl   $0x3,0x8(%ebp)
{
  ...
  13:	c7 44 24 04 18 08 00 	movl   $0x818,0x4(%esp)
  1a:	00 
  1b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  22:	e8 49 04 00 00       	call   470 <printf>
    exit();
  ...
  51:	c7 44 24 04 2b 08 00 	movl   $0x82b,0x4(%esp)
  58:	00 
 ...
 3bb:	89 d1                	mov    %edx,%ecx
{
 ...
 3fc:	0f b6 92 a0 08 00 00 	movzbl 0x8a0(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e3:	ff 24 85 48 08 00 00 	jmp    *0x848(,%eax,4)
 ...
 664:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
          s = "(null)";
 668:	bf 3f 08 00 00       	mov    $0x83f,%edi
...
free(void *ap)
{
 ...
 681:	a1 b4 08 00 00       	mov    0x8b4,%eax
{
 ...
 6c9:	5b                   	pop    %ebx
  freep = p;
 6ca:	89 15 b4 08 00 00    	mov    %edx,0x8b4
}
 6d0:	5e                   	pop    %esi
 6d1:	5f                   	pop    %edi
 6d2:	5d                   	pop    %ebp
 ...
 707:	75 be                	jne    6c7 <free+0x47>
  freep = p;
 709:	89 15 b4 08 00 00    	mov    %edx,0x8b4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 b4 08 00 00    	mov    0x8b4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 777:	73 3f                	jae    7b8 <malloc+0x88>
    ...
    if(p == freep)
 779:	39 05 b4 08 00 00    	cmp    %eax,0x8b4
 ...
 799:	e8 e2 fe ff ff       	call   680 <free>
  return freep;
 79e:	8b 15 b4 08 00 00    	mov    0x8b4,%edx
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 b4 08 00 00    	mov    %edx,0x8b4
}
 ...
 7df:	00 
    base.s.ptr = freep = prevp = &base;
 7e0:	b8 b8 08 00 00       	mov    $0x8b8,%eax
 7e5:	ba b8 08 00 00       	mov    $0x8b8,%edx
 7ea:	a3 b4 08 00 00       	mov    %eax,0x8b4
    base.s.size = 0;
 7ef:	31 c9                	xor    %ecx,%ecx
 7f1:	b8 b8 08 00 00       	mov    $0x8b8,%eax
    base.s.ptr = freep = prevp = &base;
 7f6:	89 15 b8 08 00 00    	mov    %edx,0x8b8
    base.s.size = 0;
 7fc:	89 0d bc 08 00 00    	mov    %ecx,0x8bc
    if(p->s.size >= nunits){
