...
main(int argc, char *argv[])
{
  ...
  25:	e8 d9 02 00 00       	call   303 <unlink>
  ...
  3d:	c7 44 24 04 2c 08 00 	movl   $0x82c,0x4(%esp)
  44:	00 
 ...
 3bb:	89 d1                	mov    %edx,%ecx
{
 ...
 3fc:	0f b6 92 a4 08 00 00 	movzbl 0x8a4(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e3:	ff 24 85 4c 08 00 00 	jmp    *0x84c(,%eax,4)
 ...
 664:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
          s = "(null)";
 668:	bf 45 08 00 00       	mov    $0x845,%edi
...
free(void *ap)
{
 ...
 681:	a1 b8 08 00 00       	mov    0x8b8,%eax
{
 ...
 6c9:	5b                   	pop    %ebx
  freep = p;
 6ca:	89 15 b8 08 00 00    	mov    %edx,0x8b8
}
 6d0:	5e                   	pop    %esi
 6d1:	5f                   	pop    %edi
 6d2:	5d                   	pop    %ebp
 ...
 707:	75 be                	jne    6c7 <free+0x47>
  freep = p;
 709:	89 15 b8 08 00 00    	mov    %edx,0x8b8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 b8 08 00 00    	mov    0x8b8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 777:	73 3f                	jae    7b8 <malloc+0x88>
    ...
    if(p == freep)
 779:	39 05 b8 08 00 00    	cmp    %eax,0x8b8
 ...
 799:	e8 e2 fe ff ff       	call   680 <free>
  return freep;
 79e:	8b 15 b8 08 00 00    	mov    0x8b8,%edx
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 b8 08 00 00    	mov    %edx,0x8b8
}
 ...
 7df:	00 
    base.s.ptr = freep = prevp = &base;
 7e0:	b8 bc 08 00 00       	mov    $0x8bc,%eax
 7e5:	ba bc 08 00 00       	mov    $0x8bc,%edx
 7ea:	a3 b8 08 00 00       	mov    %eax,0x8b8
    base.s.size = 0;
 7ef:	31 c9                	xor    %ecx,%ecx
 7f1:	b8 bc 08 00 00       	mov    $0x8bc,%eax
    base.s.ptr = freep = prevp = &base;
 7f6:	89 15 bc 08 00 00    	mov    %edx,0x8bc
    base.s.size = 0;
 7fc:	89 0d c0 08 00 00    	mov    %ecx,0x8c0
    if(p->s.size >= nunits){
